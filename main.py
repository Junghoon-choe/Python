...
def main():
    if not os.path.isdir("/Users/joe/Documents/Python_PlayData/정보처리기사/문제파일"):
        os.mkdir("/Users/joe/Documents/Python_PlayData/정보처리기사/문제파일")
    os.chdir("/Users/joe/Documents/Python_PlayData/정보처리기사/문제파일")
    print("현재 :", os.getcwd())
    while True:
        loginUser()
        try:
